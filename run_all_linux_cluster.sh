...
log "Removing previous benchmark outputs"
rm -f \
  benchmark_raw_trials.csv \
  benchmark_median_summary.csv \
  benchmark_speedup_vs_size.png \
  benchmark_speedup_vs_threads.png
...
echo "  - benchmark_speedup_vs_size.png"
echo "  - benchmark_speedup_vs_threads.png"
